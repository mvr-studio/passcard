...
<Article icon={TbReportSearch} title="How to choose a wallet?" description="As cryptocurrencies become more popular, the need for secure crypto wallets becomes more important.">
